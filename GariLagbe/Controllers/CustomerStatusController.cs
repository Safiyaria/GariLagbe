...
namespace GariLagbe.Controllers
{
    public class CustomerStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Status_ID,Customer_ID,Status_Time,Satus_Date,Status")] CustomerStatu customerStatu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Status_ID,Customer_ID,Status_Time,Satus_Date,Status")] CustomerStatu customerStatu)
        {
            if (ModelState.IsValid)
            {
